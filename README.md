...
| <a name="input_logs_anomalies_service_channel_mapping"></a> [logs\_anomalies\_service\_channel\_mapping](#input\_logs\_anomalies\_service\_channel\_mapping) | JSON string mapping service names to specific Slack channels (e.g., '{"api-service": "#api-alerts"}') | `string` | `"{}"` | no |
